...
public class CastmageButton extends ImageButton {
    ...
    public CastmageButton(Context context) {
        super(context);
        init(null);
    }

    public CastmageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CastmageButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @BindingAdapter("setCheckedState")
    public static void onStateChanged(CastmageButton imageButton, boolean checked) {
